...
const TopChartCard = ({song, i, isPlayng, activeSong, handlPeauseClick, handlePlayClick}) => (
        ...
        <div ref={divRef} className="xl: ml-6 ml-0 xl: mb-0 mb-6 flex-1 xl:max-w-[500px] max-w-full flex flex-col">
            <div className="w-full flex flex-col">
                ...
                <div className="mt-4 flex flex-col gap-1">
                    {topPlays?.map((song, i) => (
                        <TopChartCard key={song.key} song={song} i={i} isPlayng={isPlaying} activeSong={activeSong} handlPeauseClick={handlePauseClick} handlePlayClick={() => handlePlayClick(song, i)}/>
                    ))}
                </div>
            </div>
